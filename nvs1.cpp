...
static void load_metadata(void){
    ...
    if (preferences.isKey("x")) metadata_epprom.x = preferences.getFloat("x", 1.0);
    if (preferences.isKey("y")) metadata_epprom.y = preferences.getFloat("y", 1.0);
    if (preferences.isKey("z")) metadata_epprom.z = preferences.getFloat("z", 1.0);
    preferences.end();
    return;
}
